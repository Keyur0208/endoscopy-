...
type PatientRegisterHeaderProps = ContainerProps & {
...
export function PatientRegisterHeader({
  title,
  sx,
  children,
  currentIndex,
                  ...
                  {currentData ? (
                    ...
                    >
                      ...
                      {currentData?.createdByUser?.fullName ||
                        currentData?.createdByAdminUser?.fullName}
                    </Typography>
                  ) : (
                    <Typography
                      sx={{

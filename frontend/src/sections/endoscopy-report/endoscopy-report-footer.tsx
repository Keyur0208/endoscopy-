...
interface EndoscopyReportFormButtonProps {
  currentPath: string;
  currentData: any;
  isdisable?: boolean;
...
const EndoscopyReportFormButton: React.FC<EndoscopyReportFormButtonProps> = ({
  currentPath,
  isdisable,
  currentData,
  isSubmitting,
...
export default EndoscopyReportFormButton;

...
import { PatientRegistrationEditView } from 'src/sections/patient-registration/view';

// Metadata
const metadata = { title: `Patient Registration Details | Dashboard - ${CONFIG.site.name}` };

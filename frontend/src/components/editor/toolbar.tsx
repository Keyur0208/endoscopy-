...
export function Toolbar({
  ...
  return (
    ...
    >
      <HeadingBlock editor={editor} isdisable={isdisable} />
      ...
      {/* Link - Image */}
      <Stack direction="row" spacing={0.5}>
        <LinkBlock editor={editor} isdisable={isdisable} />
        <ImageBlock editor={editor} isdisable={isdisable} />
      </Stack>
      ...
      {fullItem && (
        <Stack direction="row" spacing={0.5}>
          <ToolbarItem
            ...
            disabled={!editor.can().chain().focus().undo().run() || isdisable}
          ...
          <ToolbarItem
            ...
            disabled={!editor.can().chain().focus().redo().run() || isdisable}
      ...
      <Stack direction="row" spacing={0.5}>
        <Tooltip title="Insert Table" arrow>
          <span>
            <ToolbarItem
              ...
              icon={
                <path d="M3 3C2.44772 3 2 3.44772 2 4V20C2 20.5523 2.44772 21 3 21H21C21.5523 21 22 20.5523 22 20V4C22 3.44772 21.5523 3 21 3H3ZM4 8V5H11V8H4ZM4 10V14H11V10H4ZM4 16V19H11V16H4ZM13 19V16H20V19H13ZM20 14V10H13V14H20ZM20 8V5H13V8H20Z" />
              }
            />
          </span>
        </Tooltip>
        ...
        {editor.isActive('table') && (
          <>
            <Tooltip title="Add Row" arrow>
              <span>
                <ToolbarItem
                  ...
                  icon={<path d="M11 11V5H13V11H19V13H13V19H11V13H5V11H11Z" />}
                />
              </span>
            </Tooltip>
            ...
            <Tooltip title="Add Column" arrow>
              <span>
                <ToolbarItem
                  ...
                  icon={<path d="M11 11H5V13H11H13H19V11H13H11Z" transform="rotate(90 12 12)" />}
                />
              </span>
            </Tooltip>
            ...
            <Tooltip title="Merge Cells" arrow>
              <span>
                <ToolbarItem
                  disabled={isdisable}
                  ...
                  icon={
                    <path d="M3 3H21V5H14V10H19V12H10V5H5V3H3ZM3 7H5V10H3V7ZM3 12H5V14H3V12ZM3 17H5V21H3V17ZM7 17H10V21H7V17ZM12 17H14V21H12V17ZM17 17H19V21H17V17Z" />
                  }
                />
              </span>
            </Tooltip>

            <Tooltip title="Split Cell" arrow>
              <span>
                <ToolbarItem
                  disabled={isdisable}
                  ...
                  icon={
                    <path d="M3 3H11V11H3V3ZM5 5V9H9V5H5ZM13 3H21V11H13V3ZM15 5V9H19V5H15ZM3 13H11V21H3V13ZM5 15V19H9V15H5ZM13 13H15V15H13V13ZM15 13H17V15H15V13ZM17 13H19V15H17V13ZM13 17H15V19H13V17ZM15 17H17V19H15V17ZM17 17H19V19H17V17ZM13 21H15V19H13V21ZM15 21H17V19H15V21ZM17 21H19V19H17V21Z" />
                  }
                />
              </span>
            </Tooltip>
            ...
            <Tooltip title="Delete Table" arrow>
              <span>
                <ToolbarItem
                  ...
                  icon={
                    <path d="M17 6H22V8H20V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V8H2V6H7V3C7 2.44772 7.44772 2 8 2H16C16.5523 2 17 2.44772 17 3V6ZM9 4V6H15V4H9ZM6 8V20H18V8H6ZM9 11H11V18H9V11ZM13 11H15V18H13V11Z" />
                  }
                />
              </span>
            </Tooltip>

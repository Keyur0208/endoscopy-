...
export const endpoints = {
  ...
  parameterMaster: {
    getAll: '/parameter-masters',
    create: '/parameter-masters',
    update: (id: number) => `/parameter-masters/${id}`,
    delete: (id: number) => `/parameter-masters/${id}`,
    getById: (id: number) => `/parameter-masters/${id}`,
    search: '/parameter-masters/search',
  },
  reportTemplate: {
    getAll: '/report-templates',
    create: '/report-templates',
    update: (id: number) => `/report-templates/${id}`,
    delete: (id: number) => `/report-templates/${id}`,
    getById: (id: number) => `/report-templates/${id}`,
    search: '/report-templates/search',
  },
  reportType: {
    getAll: '/report-types',
    create: '/report-types',
